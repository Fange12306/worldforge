...
export function InlinePermission({ toolName, details, onChoose, onDismiss }: Props) {
  return (
    <div className="animate-fade-in px-4 mb-2">
      <div className="max-w-3xl mx-auto bg-surface-800 rounded-2xl border border-surface-700 px-4 py-2.5">
        <div className="flex items-center gap-3">
          <span className="text-xs text-ink-secondary">
            Agent 想执行 <span className="font-mono text-brand-400">{toolName}</span>
